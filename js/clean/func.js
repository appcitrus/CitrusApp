...
function generateSectionProductItem(value, lazy) {
    var url = "category-items=" + value.link,
        ...
        dop_class = "";
    delete_td = (!!value.add_delete_td && value.add_delete_td == 'Y') ? '<td class="delete_td"><img item_id="' + value.id + '" class="delete_img cancel_icon" src="http://img.citrus.ua/img/svg/cancel-icon.svg"></td>' : '';
    value.id = value.id || '';
